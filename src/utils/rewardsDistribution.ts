...
const rewardConfig = {
    cardDistribution: [
        ...
        {group: 0.25, item: "020", limitBump: 30000_00, weeklyRewards: [{item: "900", quantity: 2}], role: "1268348633624084632"}, // gold {item: "900", quantity: 2}
        {group: 0.5, item: "010", limitBump: 15000_00, weeklyRewards: [{item: "900", quantity: 1}], role: "1268348167456428043"}, // green {item: "900", quantity: 1}
